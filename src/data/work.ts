...
export const workItems: WorkItem[] = [
  ...
  },
  {
    ...
    discipline: 'apps',
    blurb:
      'A marketing and booking site for an Oklahoma City counseling practice — individual, couples, and family therapy. Clean, calm, and built to make it easy for new clients to find the right therapist and reach out.',
  ...
  },
  {
    ...
    title: 'Astro Man',
    discipline: 'games',
    blurb: 'A Metroid-style 3D platformer/shooter rendered with lo-fi voxel models — exploration-driven combat with a chunky, retro-future look.',
    tags: ['Unity 6', 'URP', 'C#'],
    kind: 'link',
    status: 'In development',
  },
  ...
  {
    slug: 'donut-daze-mobile',
    title: 'Donut Daze Mobile',
    discipline: 'games',
    blurb: 'A mobile auto-runner spin-off of Donut Daze — momentum-based traversal across slopes, ramps, rails, and loops while collecting candies and food power-ups.',
    tags: ['Unity 6', 'Mobile'],
    kind: 'link',
    status: 'Prototype',
  },
  {
    ...
    title: 'Lawn Care Sim',
    discipline: 'games',
    blurb: 'A cozy, low-poly 3D business sim: mow lawns, get paid, build a reputation, and grow a lawn-care empire one client at a time.',
    tags: ['Unity 6', 'URP', '3D'],
    kind: 'link',
    status: 'In development',
  },
